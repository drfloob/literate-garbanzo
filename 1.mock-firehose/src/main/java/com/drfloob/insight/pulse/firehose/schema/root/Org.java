...
public class Org extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.drfloob.insight.pulse.firehose.schema.root.Org.Builder newBuilder() {
    return new com.drfloob.insight.pulse.firehose.schema.root.Org.Builder();
  }
   ...
   * @return A new Org RecordBuilder
   */
  public static com.drfloob.insight.pulse.firehose.schema.root.Org.Builder newBuilder(com.drfloob.insight.pulse.firehose.schema.root.Org.Builder other) {
    return new com.drfloob.insight.pulse.firehose.schema.root.Org.Builder(other);
  }
   ...
   * @return A new Org RecordBuilder
   */
  public static com.drfloob.insight.pulse.firehose.schema.root.Org.Builder newBuilder(com.drfloob.insight.pulse.firehose.schema.root.Org other) {
    return new com.drfloob.insight.pulse.firehose.schema.root.Org.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Org>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.drfloob.insight.pulse.firehose.schema.root.Org.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.drfloob.insight.pulse.firehose.schema.root.Org other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder setId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder setLogin(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder clearLogin() {
      login = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder setGravatarId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder clearGravatarId() {
      gravatar_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder setAvatarUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder clearAvatarUrl() {
      avatar_url = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder setUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Org.Builder clearUrl() {
      url = null;
