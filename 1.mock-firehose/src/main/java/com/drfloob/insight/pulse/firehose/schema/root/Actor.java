...
public class Actor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2025029056443059260L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Actor\",\"namespace\":\"com.drfloob.insight.pulse.firehose.schema.root\",\"fields\":[{\"name\":\"id\",\"type\":[\"long\",\"null\"]},{\"name\":\"login\",\"type\":[\"string\",\"null\"]},{\"name\":\"gravatar_id\",\"type\":[\"string\",\"null\"]},{\"name\":\"avatar_url\",\"type\":[\"string\",\"null\"]},{\"name\":\"url\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public Actor(java.lang.Long id, java.lang.CharSequence login, java.lang.CharSequence gravatar_id, java.lang.CharSequence avatar_url, java.lang.CharSequence url) {
    this.id = id;
    this.login = login;
   ...
   */
  public static com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder newBuilder() {
    return new com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder();
  }
   ...
   * @return A new Actor RecordBuilder
   */
  public static com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder newBuilder(com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder other) {
    return new com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder(other);
  }
   ...
   * @return A new Actor RecordBuilder
   */
  public static com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder newBuilder(com.drfloob.insight.pulse.firehose.schema.root.Actor other) {
    return new com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Actor>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.drfloob.insight.pulse.firehose.schema.root.Actor other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder setId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder setLogin(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder clearLogin() {
      login = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder setGravatarId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder clearGravatarId() {
      gravatar_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder setAvatarUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder clearAvatarUrl() {
      avatar_url = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder setUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.drfloob.insight.pulse.firehose.schema.root.Actor.Builder clearUrl() {
      url = null;
